...
Using the [example dataset](https://github.com/FreddieJH/r_workshop/blob/main/example_data.csv), for Chordates only, get the mean abundance of individuals (rename 'total' to 'abundance'), within each taxonomic family.
:::
