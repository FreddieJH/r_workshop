...
raw_dat <- tribble(
  ~species_name , ~size , ~abundance , ~sex  , ~sst ,
  "A"           ,  2.5  ,        100 , "juv" ,   13 ,
  "A"           ,  2.5  ,        105 , "juv" ,   13 ,
  "A"           ,  5    ,         90 , "m"   ,   14 ,
  "A"           ,  5    ,      93845 , "f"   ,   14 ,
...
write_csv(raw_dat, "analysis1.csv")
```
...
Download parquet file (5 mb)- [Click here to download](https://raw.githubusercontent.com/FreddieJH/r_workshop/main/AODN_output.parquet)
