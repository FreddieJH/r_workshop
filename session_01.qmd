...
![](images/r-analysis.PNG){.fragment .absolute bottom="50" right="300" width="700" height="300"} ![](images/r-art.PNG){.fragment .absolute bottom="50" right="300" width="700" height="300"} ![](images/r-chess.PNG){.fragment .absolute bottom="50" right="300" width="700" height="300"} ![](images/r-presentation.PNG){.fragment .absolute bottom="50" right="300" width="700" height="300"}
...
![](images/rstudio-capture.PNG){.fragment .center height="300"}
:::
::::
...
- Download 'cape_howe.csv' - [Click here to download](https://raw.githubusercontent.com/FreddieJH/r_workshop/main/cape_howe.csv)
...
library(readr)
read_csv("cape_howe.csv", n_max = 6)
```
...
```{r}
fish_size <- read_csv("cape_howe.csv")
head(fish_size)
```
...
- Today's slides are available at: <https://freddiejh.github.io/r_workshop/>