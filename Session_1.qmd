---
title: "The basics"
subtitle: "Getting started with R (1/4)"
author: "Freddie Heather (Presented by: Asta Audzijonyte)"
format: revealjs
project:
  output-dir: docs
---
...
-   **Problem 1:** Given an excel file with 1M+ rows, find errors in a species geographical distribution.

-   **Problem 2:** Reading and replicating analyses from complex methods sections is not fun.

-   **Solution:** R

# Today's workshop

-   I will go through the slides, **feel free to stop and ask questions**.
-   We will go through the example code with each slide (Lesson1ScriptToDistribute.R)
-   At the end, you can get the slides online.
...
![](images/r-analysis.PNG){.fragment .absolute bottom="100" right="300" width="500" height="300"} ![](images/r-art.PNG){.fragment .absolute bottom="100" right="300" width="500" height="300"} ![](images/r-chess.PNG){.fragment .absolute bottom="100" right="300" width="500" height="300"} ![](images/r-presentation.PNG){.fragment .absolute bottom="100" right="300" width="500" height="300"} ![](images/r-analysis.PNG){.fragment .absolute bottom="100" right="300" width="500" height="300"} ![](images/r-website.PNG){.fragment .absolute bottom="100" right="300" width="500" height="300"} ![](images/r-website2.PNG){.fragment .absolute bottom="100" right="300" width="500" height="300"}
...
-   There are some packages that are used so often, they form part of the `tidyverse`
-   `tidyverse` is a special package in that it is just a collection of packages
...
-   Get the slides from https://github.com/FreddieJH/r_workshop
