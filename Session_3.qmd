...
-   Today we will use the data from the Reef Life Survey data again
-  The data is pre-filtered for the Marine Ecoregion: Cape Howe

::: callout-tip
## Task

1.  Download the file "cape_howe.csv" from [this link](https://github.com/FreddieJH/r_workshop/blob/main/cape_howe.csv)
...
# scatterplot of mean size vs. total abundance
sizes_byspp %>% 
